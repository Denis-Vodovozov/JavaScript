...
const productsSale = products;
Object.values(productsSale).forEach((sale) => {
...
console.log(
  productS.filter(
    (productPhoto) => productPhoto.photos && productPhoto.photos.length !== 0
  )
);
...
console.log(
  productS.sort(
    (productPriceMin, productPriceMax) =>
      productPriceMin.price - productPriceMax.price
  )
);
